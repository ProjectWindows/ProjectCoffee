...
namespace CoffeeManage.LopXuLyDuLieu
{
    class TaiKhoan
    {
        ...
        //public DataTable KiemTraTaiKhoan(string UserName, ref string err)
        //{
        //    KetNoi.sqlcnt.Open();
        //    // KetNoi.sqlda = new SqlDataAdapter("select * from UserLogin where UserName='" + UserName + "'", KetNoi.sqlcnt);  
        //    DataTable dt = new DataTable();
        //    KetNoi.sqlda.Fill(dt);
        //    KetNoi.sqlcnt.Close();
        //    return dt;
